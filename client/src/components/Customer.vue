<template>
  <div class="container">
    <el-form ref="form" :model="customer" label-width="120px">
      ...
      <el-form-item label="대표자">
        <el-input v-model="customer.representative"></el-input>
      </el-form-item>
      <el-form-item label="사업자등록번호">
        <el-input v-model="customer.corporate_registration_number"></el-input>
      </el-form-item>
      ...
      <el-form-item>
        <el-button type="primary" @click="onSubmit">등록하기</el-button>
